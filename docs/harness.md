...
| 문서 검사        | `scripts/check-docs.mjs`            | 문서(`README.md` 포함)에 적힌 `pnpm` 명령 · 경로 · 링크 · 이미지가 실제로 있는지                                                                                                                                                 |
...
| 위치             | 언제 로드                      | 담는 것                                                                                                                                                                                                       |
| ---------------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `README.md`      | 사람이 레포에 처음 올 때       | 서비스 소개, 주요 기능(화면 사진), 화면 원칙, 기술적 도전, AI 활용, 시작하기, 팀. 해요체 짧은 문장과 사진 위주로 쓰고, 항목은 두세 줄로 줄인 뒤 자세한 내용은 `docs/` 로 링크한다. 화면 사진은 `docs/images/` |
